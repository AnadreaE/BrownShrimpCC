...
#### continue with shifting funciton ####
#the parameter values where calculated in file determine_growthFunction.R

shift_next_sizeClass_old = function(Te, sizeClass){
  ratio = 0
  if (Te <= 1) {
    ratio = 0
  } else {
...
state2 <- c(P = 2, E = 0.1, L= 0.4 , J = .175 , J2 = 0.125, J3 = 0.125, J4 = 0.1, J5 = 0.1,
...
stack_order_Br <- rev(c(colnames(test_briere)[2:11]) )
